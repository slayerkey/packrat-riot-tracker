...
check("revision: nextRevision()" in pi_js, "Property Inspector versions global settings writes")
...
check("private lastRevision" in service and "nextRevision < this.lastRevision" in service, "stale global settings events cannot repaint older session state")
